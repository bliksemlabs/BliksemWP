...
bool router_request_from_qstring(router_request_t*, tdata_t *td);

void router_request_dump(router_t *router, router_request_t *req);

void router_request_initialize(router_request_t *req);

void router_request_randomize(router_request_t *req, tdata_t *td);
...
uint32_t router_result_dump(router_t *router, router_request_t *req, char *buf, uint32_t buflen); // return num of chars written

void router_request_from_epoch(router_request_t *req, tdata_t *td, time_t epochtime);

time_t req_to_date (router_request_t *req, tdata_t *td, struct tm *tm_out);

time_t req_to_epoch (router_request_t *req, tdata_t *td, struct tm *tm_out);

uint32_t transfer_distance (tdata_t *td, uint32_t stop_index_from, uint32_t stop_index_to);
